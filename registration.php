    ...
    <section>
        <div class="sec_sign">
            <div class="box2" id="reg">
                <h1 style="font-size: 21px;">STUDENT REGISTRATION FORM</h1>
                <form action="" name="registration" method="post" enctype="multipart/form-data">
                    ...
                    <div class="login">
                        ...
                        <button type="submit" name="submit" style="font-family: auto;font-size:17px">SUBMIT</button>
                    </div>
                </form>
            <?php
                        ...
                        if (isset($_FILES['image']) && $_FILES['image']['error'] == UPLOAD_ERR_OK) {
                            ...
                            if (in_array($imageType, $allowedTypes)) {
                                ...
                                if (move_uploaded_file($image['tmp_name'], $imagePath)) {
                                    ...
                                    $query = "INSERT INTO register (first, last, username, password, image_path, email, phone) VALUES ('$first', '$last', '$username', '$hashed_password', '$imagePath', '$email', '$phone')";
