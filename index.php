    ...
    <div class="wrapper">
        <header>
            ...
            <?php
               ...
               {
                ?>
                 <ul class="nav navbar-nav navbar-right" style="padding-right: 10px;font-family: auto;text-align:right;margin-bottom:0px;">
                <li>
                <div style="color: white;margin-top:10px;margin-right:10px; display: flex; justify-content: end;">
                    <div style="margin-bottom:10px;">
                    <?php
                    if(isset($_SESSION['image']))
                    {
                        echo "<img class='img-circle profile_img' height='40px' width='40px' style='border-radius:100px 100px;' src='".$_SESSION['image']."'>";
                    }
                    ?>
                    </div>
                    <div style="font-size:20px; margin-top: 10px;">
                    <?php
                    echo "<strong>&nbsp;&nbsp;".$_SESSION['login_user']."</strong>";
                    ?>
                    </div>
                </div>
                </li></ul>
