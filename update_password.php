    ...
    <section>
        ...
        <?php
           if(isset($_POST['submit']))
           {
            ...
            $query2 = "SELECT * FROM register WHERE username='$username' AND email='$email'";
            ...
            else
            {
                ...
                {
                    $query7="UPDATE register SET password='$password' WHERE username='$username' AND email='$email'";
