...
<body style="background-color: cadetblue;">
    ...
    <div class="wrapper">
        <?php
           ...
           $query6="SELECT * FROM register WHERE username='$_SESSION[login_user]'";
           $res=mysqli_query($db,$query6);
        ?>
        <h1 style="padding-top:15px; color:black;"><b>My Profile</b></h1>
        <?php
           $row=mysqli_fetch_assoc($res);
           echo "<div><img class='img-circle profile_img' height='100px' width='100px' style='border-radius:100px 100px;' src='".$_SESSION['image']."'></div>"
        ?>
        <div>
            <h2 style="color:black;"><b>Welcome</b></h2>
            <h2 style="color:black;"><?php echo $_SESSION['login_user'] ?></h2>
        </div><br>
