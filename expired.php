  ...
  document.getElementById("main").style.marginLeft= "0";
   ...
   <div class="container">
    <?php
       ...
       {
            ?>
             <h1 style="font-size:33px;">Date Expired List</h1><br><br>
        <div>
            ...
            {
                $q2="UPDATE issue_book SET approve='Returned' WHERE username='$_POST[username]' AND book_id='$_POST[book_id]'";
                mysqli_query($db,$q2);
            }
            $count=0;
        $sql="SELECT register.username,books.book_id,name,author,edition,approve,issue_book.issue,issue_book.return FROM register inner join issue_book ON register.username=issue_book.username inner join books ON issue_book.book_id=books.book_id WHERE issue_book.approve!='Yes' ORDER BY `issue_book`.`return` ASC";
