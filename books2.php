...
function closeNav() {
  ...
  document.getElementById("main").style.marginLeft= "0";
    ...
    <div style="display:flex;width: 1450px;">
        <form action="" class="navbar-form" method="post" name="form1" style="padding: 0px;">
            <div>
                <input style="color: black; background-color: whitesmoke; border:3px solid black; border-radius:7px 7px; height: 45px;" type="text" name="search" placeholder="Search Books..." required>
                <button type="submit" name="searchb" style="height: 41px; width: 50px; border: 2px solid black; color: white;">
      ...
      {
          ?>
        <form action="" class="navbar-form" method="post" name="form1" style="padding: 0px;padding-left: 450px;">
            <div>
                ...
                <button type="submit" name="delete" style="height: 41px; width: 80px; border: 2px solid black; color: white; font-size:17px;">
                  Delete
                </button>
            </div>
        </form><br>
    ...
    {
        $query5="SELECT * FROM books WHERE name like '%$_POST[search]%'";
        ...
        if(mysqli_num_rows($res2)==0)
        {
            ?>
               <div class="searchbox">
            <?php
            echo "<strong style='color:red;font-size:17px;margin-left: 20px;'>Sorry! No book found.</strong>";
                    ?>
    ...
    {
      $query9="DELETE FROM books WHERE book_id='$_POST[book_id]'";
      $res=mysqli_query($db,$query9);
      ?>
         <script>
